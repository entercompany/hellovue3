<template>
  <div class="flex w-full">
    <div class="m-auto">
      ...
      <p class="text-3xl text-right mt-10 mb-2 w-40 overflow-x-scroll" style="direction:rtl">{{currentNum}}</p>
...
export default {
 setup(){
  ...
  return {calculation, pressed, selectedOperation,currentNum,prevNum}
 }
